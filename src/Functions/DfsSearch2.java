...
public class DfsSearch2 {
     ...
     *
     */
    ArrayList<TimeTablePuzzle2> path;
     ...
     */
    private boolean SearchPath(TimeTablePuzzle2 puzzle){
        for (TimeTablePuzzle2 item : path){
            if (item == puzzle){
                return true;
            }
        }
     ...
     * cannot be solved.
     */
    private TimeTablePuzzle2 getNextMove(TimeTablePuzzle2 puzzle, Set<String> seen){
        ArrayList<TimeTablePuzzle2> configs = puzzle.extensions();
        ...
        for (TimeTablePuzzle2 possible_move : configs){
     ...
     */
    public ArrayList<TimeTablePuzzle2> solve(TimeTablePuzzle2 puzzle, Set<String> seen) {
        ...
        // If the puzzle is not solved and is possible
            ...
            TimeTablePuzzle2 next_item = puzzle;
            path.add(next_item);
