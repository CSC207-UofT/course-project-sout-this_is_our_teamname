...
public class TimeTablePuzzle2 {
     ...
     */
    public TimeTablePuzzle2(HashMap<String, HashMap<String,
            ArrayList<Course>>> courses, TimeTableManager manager,
                            ArrayList<ArrayList<Course>> unscheduledCourses,
                            ArrayList<Course> scheduled) {
        this.courses = courses;
        this.manager = manager;
        this.scheduled = scheduled;
        this.unscheduled = unscheduledCourses;
     ...
     */
    public ArrayList<TimeTablePuzzle2> extensions() {
        ArrayList<TimeTablePuzzle2> extensions = new ArrayList<>();
